...
<section class="section">
  <div class="container">
    <div class="recruit-message">
      ...
      <p>i2m2は『全ての関わる人に幸運と繁栄を』をミッションに掲げ、ヘルスケアを起点とした事業を展開しています。創業1年3ヶ月で累計取扱高36億円を超えた当社で、あなたの経験を活かしてみませんか。</p>
    </div>
  </div>
</section>
...
`, { description: '創業1年3ヶ月で累計取扱高36億円超のヘルスケア企業で働きませんか。M&Aアドバイザー・医療マーケ・人材アドバイザー募集中。' }))
}
