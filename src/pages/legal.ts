...
<section class="section">
  <div class="container">
    <div class="legal-content">
      <p>株式会社イズムズ（以下「当社」）は、個人情報の保護に関する法律その他の関連法令を遵守し、以下のとおり個人情報保護方針を定め、これを実行してまいります。</p>
      <h3>1. 個人情報の収集</h3>
      ...
      <p class="legal-date">制定日：2025年1月1日<br>株式会社イズムズ</p>
    </div>
  </div>
</section>
`))
...
<section class="section">
  <div class="container">
    <div class="legal-content">
      <p>この利用規約は、株式会社イズムズが提供する各種サービスの利用条件を定めるものです。</p>
      <h3>第1条（適用）</h3>
