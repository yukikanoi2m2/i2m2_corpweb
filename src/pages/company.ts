...
`, { description: '株式会社イズムズ（i2m2 Co., Ltd.）の会社概要。2023年設立。六本木ヒルズ森タワー37F。ヘルスケア領域の地域価値創造事業を展開。' }))
}

function messagePage(c: Context) {
  return c.html(layout('事業責任者メッセージ', `
${breadcrumb([{ label: '会社情報', href: '/company' }, { label: '事業責任者メッセージ' }])}

<section class="page-hero">
  <div class="container">
    <h1 class="page-hero-title">事業責任者メッセージ</h1>
    <p class="page-hero-desc">MESSAGE FROM EXECUTIVE</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="message-page-wrap">
      ...
      <div class="message-page-content">
        ...
        <p>株式会社イズムズは2023年の創業以来、医療・ヘルスケア領域を中心に、M&A仲介・医療マーケティング・人材マッチング・医療DXの4つの軸でサービスを展開してまいりました。</p>
        ...
        <p>創業から2年で累計取扱高20億円・グループ総取引1,000件超の実績を積み重ねることができたのは、ひとえにお客様・パートナーの皆様からのご信頼のおかげと感謝しております。</p>
        <p>私たちの目標は、ヘルスケアを起点とした地域価値創造（Regional Value Creation）のプラットフォームを日本全国に広げ、地域社会の持続的な発展に貢献することです。</p>
        <p>引き続きご支援・ご指導のほど、よろしくお願いいたします。</p>
        <p class="message-author-block">株式会社イズムズ<br>事業責任者 鹿之賦 勇輝</p>
      </div>
    </div>
  </div>
</section>
...
${ctaSection({ title: '事業内容・お取引についてのご質問もお気軽にどうぞ。' })}
`, { description: '株式会社イズムズ事業責任者 鹿之賦勇輝からのメッセージ。医療現場への伴走支援と地域価値創造への思いをお伝えします。' }))
}
