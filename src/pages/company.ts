    ...
    <div class="history-timeline">
      <div class="history-item">
        ...
        <div class="history-content">
          <h4>株式会社イズムズ 設立</h4>
          <p>ヘルスケア領域に特化した地域価値創造企業として創業。以降、複数クリニックの経営に関与。</p>
        </div>
      </div>
      <div class="history-item">
...
function messagePage(c: Context) {
  return c.html(layout('プロジェクトマネージャーメッセージ', `
${breadcrumb([{ label: '会社情報', href: '/company' }, { label: 'プロジェクトマネージャーメッセージ' }])}

<section class="page-hero">
  <div class="container">
    <h1 class="page-hero-title">プロジェクトマネージャーメッセージ</h1>
    <p class="page-hero-desc">MESSAGE FROM PROJECT MANAGER</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="message-page-wrap">
      <div class="message-page-content">
        ...
        <p class="message-author-block">株式会社イズムズ<br>プロジェクトマネージャー 鹿之賦 勇輝</p>
      </div>
    </div>
  </div>
</section>
...
${ctaSection({ title: '事業内容・お取引についてのご質問もお気軽にどうぞ。' })}
`, { description: '株式会社イズムズ プロジェクトマネージャー 鹿之賦勇輝からのメッセージ。医療現場への伴走支援と地域価値創造への思いをお伝えします。' }))
}
