...
<p>当社は「Bonanza: Fortune Smiles!（全ての関わる人に幸運と繁栄を）」を企業理念に掲げ、ヘルスケア領域を起点とした地域価値創造事業を展開しております。クリニック経営支援、美容サロン事業、M&A仲介、補助金コンサルティングなど、多角的な事業を通じて急速な成長を実現してまいりました。</p>
...
<p>今後も首都圏を中心にエリアを拡大予定です。</p>`
  },
  {
    ...
    content: `<p>ヘルスケア領域に特化した地域価値創造企業として株式会社イズムズ（i2m2 Co., Ltd.）を設立いたしました。</p>
