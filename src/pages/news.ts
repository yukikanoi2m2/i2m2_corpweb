...
const newsData = [
  {
    ...
    tag: 'IR',
    tagColor: '#b8860b',
    title: 'グループ社員641名突破・総売上36億円を達成いたしました',
    content: `<p>株式会社イズムズは、2025年4月の創業から約1年2ヶ月でグループ社員641名以上、総売上36億円を突破いたしました。</p>
<p>これもひとえに、お客様・パートナー企業の皆様のご支援の賜物と心より感謝申し上げます。</p>
<p>当社は「Bonanza: Fortune Smiles!（全ての関わる人に幸運と繁栄を）」を企業理念に掲げ、ヘルスケア領域を起点とした事業を展開しております。クリニック経営支援、美容サロン事業、M&A仲介、経営改善支援など、多角的な事業を通じて急速な成長を実現してまいりました。</p>
...
<p>引き続きご支援・ご指導のほど、よろしくお願いいたします。</p>`
  },
  {
    ...
    tag: '事業報告',
    tagColor: '#2563a8',
    title: '経営改善支援サービスを開始いたしました',
    content: `<p>医療機関向けの経営改善支援サービスを正式にリリースいたしました。</p>
<h3>サービス内容</h3>
<ul>
<li>経営計画策定・財務分析</li>
<li>資金繰り改善・資金調達支援</li>
<li>事業再構築・収益改善</li>
<li>経営戦略立案・実行支援</li>
<li>各種補助金・助成金の活用サポート</li>
</ul>
<p>経営課題の分析から改善施策の実行まで一気通貫でサポートいたします。医療機関の持続的な成長にぜひお役立てください。</p>
